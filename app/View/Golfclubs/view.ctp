...
</tr><tr>		<td><strong><?php echo __('Golfname'); ?></strong></td>
		<td>
			<?php echo h($golfclub['Golfclub']['golfname']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Golfadress'); ?></strong></td>
		<td>
			<?php echo h($golfclub['Golfclub']['golfadress']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Golfemail'); ?></strong></td>
		<td>
			<?php echo h($golfclub['Golfclub']['golfemail']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
