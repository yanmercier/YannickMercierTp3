...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Golfclub'); ?></h2>

		<div class="golfclubs form">
		
			<?php echo $this->Form->create('Golfclub', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('golfname', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('golfadress', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('golfemail', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
