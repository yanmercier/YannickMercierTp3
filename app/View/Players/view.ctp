...
</tr><tr>		<td><strong><?php echo __('PlayerName'); ?></strong></td>
		<td>
			<?php echo h($player['Player']['playerName']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('PlayerAddress'); ?></strong></td>
		<td>
			<?php echo h($player['Player']['playerAddress']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('PlayerEmail'); ?></strong></td>
		<td>
			<?php echo h($player['Player']['playerEmail']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
