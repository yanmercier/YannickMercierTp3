		...
		<div class="players index">
			...
			<div class="table-responsive">
				<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
					<thead>
						<tr>
							<th><?php echo $this->Paginator->sort('playerName'); ?></th>
							<th><?php echo $this->Paginator->sort('playerAddress'); ?></th>
							<th><?php echo $this->Paginator->sort('playerEmail'); ?></th>
					...
					<tbody>
						<?php foreach ($players as $player): ?>
							<tr>
								<td><?php echo h($player['Player']['playerName']); ?>&nbsp;</td>
								<td><?php echo h($player['Player']['playerAddress']); ?>&nbsp;</td>
								<td><?php echo h($player['Player']['playerEmail']); ?>&nbsp;</td>
								<td class="actions">
									<?php echo $this->Html->link(__('View'), array('action' => 'view', $player['Player']['id']), array('class' => 'btn btn-default btn-xs')); ?>
									<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $player['Player']['id']), array('class' => 'btn btn-default btn-xs')); ?>
									<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $player['Player']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $player['Player']['id'])); ?>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
