		...
		<div class="players form">
			...
			<?php echo $this->Form->create('Player', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('playerName', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('playerAddress', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('playerEmail', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
