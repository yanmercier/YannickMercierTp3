<?php
App::uses('ParticipantsTournamentsController', 'Controller');

/**
 * ParticipantsTournamentsController Test Case
 *
 */
class ParticipantsTournamentsControllerTest extends ControllerTestCase {
